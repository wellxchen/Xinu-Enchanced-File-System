...
#define	LF_AREA_ROOT	0		/* first sector of root	*/
...
struct	lfdbfree {
	...
	char	lf_unused[LF_BLKSIZ - sizeof(dbid32)];//ldentry
};
...
struct	lfdir	{			/* entire directory on disk	*/
    ...
    ibid32  lfd_iroot; //root i block
    
	char	padding[500];		/* unused chars in directory blk*/
};
#pragma pack()
...
struct	lfdata	{			/* local file system data	*/
	...
	bool8	lf_dirpresent;		/* True when root is in	*/
