...
extern status mkdir(char *);

extern int lflistdirh(did32, char *);

extern void findDestination (did32, ibid32, int, int, char [100][50], int, int *);
extern void findFD (did32, ibid32, int, int, char [100][50], int * , struct	lflcblk	*, int, char *);

extern int strcmp (char * , char * );

extern int extractPath (char *, char [100][50]);

extern int strlen(char * );

extern int numofpaths (char *);
